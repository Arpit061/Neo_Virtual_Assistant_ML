...
#-------------- SEQUENTIAL MODEL portion 

model = Sequential()
model.add(Embedding(vocab_size, embedding_dim, input_length=max_len))    #---I/P layer
model.add(GlobalAveragePooling1D()) 
model.add(Dense(16, activation="relu"))                                  #---activation layer
model.add(Dense(16, activation="relu"))
model.add(Dense(number_of_classes, activation="softmax"))                #-----softmax = multi clssification task
